            ...
            <div class="row">
              <div class="col-md-12">
                <div class="card mb-4">
                  ...
                  <?php foreach ($db->tampil_data_siswa() as $x) { ?>
                        ...
                        <form action="" method="POST">
                          ...
                          <div class="modal-body">
                            ...
                            <div class="mb-3">
                              ...
                              <textarea class="form-control" name="alamat" rows="2"><?= htmlspecialchars($x['alamat']); ?></textarea>
                            </div>
                            <div class="row">
                              <div class="col-md-6">
                                <div class="mb-3">
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <p class="text-center">Yakin ingin menghapus data siswa ini?</p>
                          <div class="card bg-light">
                            <div class="card-body">
                              <div class="row">
                                <div class="col-4"><strong>NISN:</strong></div>
                                <div class="col-8"><?= htmlspecialchars($x['nisn']); ?></div>
                              </div>
                              <div class="row">
                                <div class="col-4"><strong>Nama:</strong></div>
                                <div class="col-8"><?= htmlspecialchars($x['nama']); ?></div>
                              </div>
                              <div class="row">
                                <div class="col-4"><strong>Kelas:</strong></div>
                                <div class="col-8"><?= htmlspecialchars($x['kelas']); ?></div>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div class="modal-footer">
                          ...
                          <a href="hapus_data.php?idsiswa=<?= $x['idsiswa']; ?>" class="btn btn-danger">
